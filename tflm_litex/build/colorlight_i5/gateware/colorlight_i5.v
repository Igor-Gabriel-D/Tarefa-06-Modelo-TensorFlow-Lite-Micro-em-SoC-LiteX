...
reg           ledchaser_chaser = 1'd0;
reg    [24:0] ledchaser_count = 25'd30000000;
wire          ledchaser_done;
reg           ledchaser_leds = 1'd0;
reg           ledchaser_mode = 1'd0;
reg           ledchaser_re = 1'd0;
reg           ledchaser_storage = 1'd0;
wire          ledchaser_wait;
...
assign ledchaser_wait = (~ledchaser_done);
always @(*) begin
    ledchaser_leds <= 1'd0;
    if ((ledchaser_mode == 1'd1)) begin
        ledchaser_leds <= ledchaser_storage;
    end else begin
        ledchaser_leds <= ledchaser_chaser;
    end
end
assign {user_led_n0} = (ledchaser_leds ^ 1'd0);
assign ledchaser_done = (ledchaser_count == 1'd0);
...
assign leds_ext = gpioout_storage;
always @(*) begin
...
assign csr_bankarray_csrbank1_out0_w = gpioout_storage;
...
assign basesoc_sdram_command_issue_r = csr_bankarray_interface2_bank_bus_dat_w[0];
always @(*) begin
    ...
    if ((csr_bankarray_csrbank2_sel & (csr_bankarray_interface2_bank_bus_adr[8:0] == 2'd2))) begin
        basesoc_sdram_command_issue_re <= csr_bankarray_interface2_bank_bus_we;
        basesoc_sdram_command_issue_we <= csr_bankarray_interface2_bank_bus_re;
    end
end
...
assign csr_bankarray_csrbank2_dfii_control0_w = basesoc_sdram_storage;
...
assign csr_bankarray_csrbank2_dfii_pi0_command0_w = basesoc_sdram_command_storage;
assign csr_bankarray_csrbank2_dfii_pi0_address0_w = basesoc_sdram_address_storage;
assign csr_bankarray_csrbank2_dfii_pi0_baddress0_w = basesoc_sdram_baddress_storage;
assign csr_bankarray_csrbank2_dfii_pi0_wrdata0_w = basesoc_sdram_wrdata_storage;
assign csr_bankarray_csrbank2_dfii_pi0_rddata_w = basesoc_sdram_rddata_status;
assign basesoc_sdram_rddata_we = csr_bankarray_csrbank2_dfii_pi0_rddata_we;
...
assign basesoc_master_rxtx_r = csr_bankarray_interface3_bank_bus_dat_w;
always @(*) begin
    ...
    if ((csr_bankarray_csrbank3_sel & (csr_bankarray_interface3_bank_bus_adr[8:0] == 3'd4))) begin
        basesoc_master_rxtx_re <= csr_bankarray_interface3_bank_bus_we;
        basesoc_master_rxtx_we <= csr_bankarray_interface3_bank_bus_re;
    end
end
...
assign csr_bankarray_csrbank3_phy_clk_divisor0_w = basesoc_spiflash_phy_storage;
assign csr_bankarray_csrbank3_mmap_dummy_bits0_w = basesoc_mmap_storage;
assign csr_bankarray_csrbank3_master_cs0_w = basesoc_master_cs_storage;
...
assign csr_bankarray_csrbank3_master_phyconfig0_w = basesoc_master_phyconfig_storage;
always @(*) begin
...
assign csr_bankarray_csrbank3_master_status_w = basesoc_master_status_status;
assign basesoc_master_status_we = csr_bankarray_csrbank3_master_status_we;
...
always @(posedge sys_clk) begin
    ...
    if (ledchaser_done) begin
        ledchaser_chaser <= {ledchaser_chaser, (~ledchaser_chaser)};
    end
    if (ledchaser_re) begin
        ledchaser_mode <= 1'd1;
    end
    if (ledchaser_wait) begin
        if ((~ledchaser_done)) begin
            ledchaser_count <= (ledchaser_count - 1'd1);
        end
    end else begin
        ledchaser_count <= 25'd30000000;
    end
    case (basesoc_grant)
        1'd0: begin
    ...
    if (csr_bankarray_csrbank1_out0_re) begin
        gpioout_storage <= csr_bankarray_csrbank1_out0_r;
    end
    gpioout_re <= csr_bankarray_csrbank1_out0_re;
    ...
    if (csr_bankarray_csrbank2_sel) begin
        case (csr_bankarray_interface2_bank_bus_adr[8:0])
            ...
            2'd2: begin
                csr_bankarray_interface2_bank_bus_dat_r <= basesoc_sdram_command_issue_w;
            end
            2'd3: begin
    ...
    if (csr_bankarray_csrbank2_dfii_control0_re) begin
        basesoc_sdram_storage <= csr_bankarray_csrbank2_dfii_control0_r;
    end
    basesoc_sdram_re <= csr_bankarray_csrbank2_dfii_control0_re;
    if (csr_bankarray_csrbank2_dfii_pi0_command0_re) begin
        basesoc_sdram_command_storage <= csr_bankarray_csrbank2_dfii_pi0_command0_r;
    end
    basesoc_sdram_command_re <= csr_bankarray_csrbank2_dfii_pi0_command0_re;
    if (csr_bankarray_csrbank2_dfii_pi0_address0_re) begin
        basesoc_sdram_address_storage <= csr_bankarray_csrbank2_dfii_pi0_address0_r;
    end
    basesoc_sdram_address_re <= csr_bankarray_csrbank2_dfii_pi0_address0_re;
    if (csr_bankarray_csrbank2_dfii_pi0_baddress0_re) begin
        basesoc_sdram_baddress_storage <= csr_bankarray_csrbank2_dfii_pi0_baddress0_r;
    end
    basesoc_sdram_baddress_re <= csr_bankarray_csrbank2_dfii_pi0_baddress0_re;
    if (csr_bankarray_csrbank2_dfii_pi0_wrdata0_re) begin
        basesoc_sdram_wrdata_storage <= csr_bankarray_csrbank2_dfii_pi0_wrdata0_r;
    end
    basesoc_sdram_wrdata_re <= csr_bankarray_csrbank2_dfii_pi0_wrdata0_re;
    basesoc_sdram_rddata_re <= csr_bankarray_csrbank2_dfii_pi0_rddata_re;
    ...
    if (csr_bankarray_csrbank3_sel) begin
        case (csr_bankarray_interface3_bank_bus_adr[8:0])
            ...
            3'd4: begin
                csr_bankarray_interface3_bank_bus_dat_r <= basesoc_master_rxtx_w;
            end
            3'd5: begin
    ...
    if (csr_bankarray_csrbank3_phy_clk_divisor0_re) begin
        basesoc_spiflash_phy_storage <= csr_bankarray_csrbank3_phy_clk_divisor0_r;
    end
    basesoc_spiflash_phy_re <= csr_bankarray_csrbank3_phy_clk_divisor0_re;
    if (csr_bankarray_csrbank3_mmap_dummy_bits0_re) begin
        basesoc_mmap_storage <= csr_bankarray_csrbank3_mmap_dummy_bits0_r;
    end
    basesoc_mmap_re <= csr_bankarray_csrbank3_mmap_dummy_bits0_re;
    if (csr_bankarray_csrbank3_master_cs0_re) begin
        basesoc_master_cs_storage <= csr_bankarray_csrbank3_master_cs0_r;
    end
    basesoc_master_cs_re <= csr_bankarray_csrbank3_master_cs0_re;
    if (csr_bankarray_csrbank3_master_phyconfig0_re) begin
        basesoc_master_phyconfig_storage <= csr_bankarray_csrbank3_master_phyconfig0_r;
    end
    basesoc_master_phyconfig_re <= csr_bankarray_csrbank3_master_phyconfig0_re;
    basesoc_master_status_re <= csr_bankarray_csrbank3_master_status_re;
...
//------------------------------------------------------------------------------
// Memory rom: 9436-words x 32-bit
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-11-28 13:43:34.
//------------------------------------------------------------------------------
